...
{
    public class EncryptionServiceNET : IEncryptionService
    {
        ...
        public async Task<string> EncryptWithX509Certificate2(X509Certificate2 cert, string plaintext)
        {
            ...
            if (cert.HasPrivateKey)
                publicKey = (RSACryptoServiceProvider)cert.PrivateKey;
            else
        ...
        //public async Task<X509Certificate2> GenerateSelfSignedCertificate(string subjectName)
        //{
